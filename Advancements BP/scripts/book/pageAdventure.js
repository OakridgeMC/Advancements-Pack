...
function open_category_adventure(player, count, max, pct) {
    ...
    if (player.hasTag('SniperDuel')) {
        adventure.button("§dSniper Duel", "textures/icons/advancement/sniper_duel.png");
    } else {
        adventure.button("Sniper Duel", "textures/icons/advancement/incomplete/sniper_duel.png");
    }
    ...
    if (player.hasTag('MonstersHunted')) {
        adventure.button("§dMonsters Hunted", "textures/icons/advancement/monsters_hunted.png");
    } else {
    ...
    if (player.hasTag('SmithingStyle')) {
        adventure.button("§dSmithing with Style", "textures/icons/advancement/smithing_with_style.png");
    } else {
    ...
    if (player.hasTag('TwoBirds')) {
        adventure.button("§dTwo Birds, One Arrow", "textures/icons/advancement/two_birds_one_arrow.png");
    } else {
    ...
    if (player.hasTag('PowerBooks')) {
        adventure.button("§aThe Power of Books", "textures/icons/advancement/the_power_of_books.png");
    } else {
        adventure.button("The Power of Books", "textures/icons/advancement/incomplete/the_power_of_books.png");
    }
    if (player.hasTag('Bullseye')) {
        adventure.button("§aBullseye", "textures/icons/advancement/bullseye.png");
    } else {
        adventure.button("Bullseye", "textures/icons/advancement/incomplete/bullseye.png");
    }
    ...
    if (player.hasTag('ItSpreads')) {
        adventure.button("§dIt Spreads", "textures/icons/advancement/it_spreads.png");
    } else {
        adventure.button("It Spreads", "textures/icons/advancement/incomplete/it_spreads.png");
    }
    ...
    if (player.hasTag('AdventuringTime')) {
        adventure.button("§dAdventuring Time", "textures/icons/advancement/adventuring_time.png");
    } else {
    ...
    if (player.hasTag('VoluntaryExile')) {
        ...
        adventure.button("Voluntary Exile", "textures/icons/advancement/incomplete/voluntary_exile.png");
    }
    if (player.hasTag('HeroVillage')) {
        adventure.button("§dHero of the Village", "textures/icons/advancement/hero_of_the_village.png");
    } else {
        adventure.button("Hero of the Village", "textures/icons/advancement/incomplete/hero_of_the_village.png");
    }
    ...
    if (player.hasTag('CountryLode')) {
        adventure.button("§aCountry Lode, Take Me Home", "textures/icons/advancement/country_lode_take_me_home.png");
    } else {
        adventure.button("Country Lode, Take Me Home", "textures/icons/advancement/incomplete/country_lode_take_me_home.png");
    }
    if (player.hasTag('LightenUp')) {
        adventure.button("§aLighten Up", "textures/icons/advancement/lighten_up.png");
    } else {
        adventure.button("Lighten Up", "textures/icons/advancement/incomplete/lighten_up.png");
    }
    ...
    if (player.hasTag('OverOverkill')) {
        adventure.button("§dOver-Overkill", "textures/icons/advancement/over_overkill.png");
    } else {
        adventure.button("Over-Overkill", "textures/icons/advancement/incomplete/over_overkill.png");
    }
    if (player.hasTag('HeartTransplanter')) {
        adventure.button("§aHeart Transplanter", "textures/icons/advancement/heart_transplanter.png");
    } else {
        adventure.button("Heart Transplanter", "textures/icons/advancement/incomplete/heart_transplanter.png");
    }


    adventure.show(player).then(r => {
        ...
        switch (response) {
            case 0:
                ...
                monsterHunter.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 3:
                ...
                throwawayJoke.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 4:
                ...
                veryFrightening.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 5:
                ...
                monstersHunted.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 7:
                ...
                stickySituation.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 9:
                ...
                smithingStyle.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 12:
                ...
                whoPillager.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 13:
                ...
                cavesCliffs.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 14:
                ...
                respectingRemnants.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 15:
                ...
                carefulRestoration.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 20:
                ...
                sweetDreams.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 21:
                ...
                adventuringTime.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 22:
                ...
                lightRabbit.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 25:
                ...
                voluntaryExile.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 26:
                ...
                VillageHero.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 30:
                ...
                countryLode.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 34:
                ...
                needsRockets.show(player).then(r => {
                    if (r.canceled) return;
            ...
            case 36:
                ...
                overOverkill.show(player).then(r => {
                    if (r.canceled) return;
